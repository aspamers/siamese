...
class SiameseNetwork(tf.keras.Model):
    ...
    """
    def __init__(self, base_model_class, head_model_class, num_classes):
        """
        ...
        * Output shape must be equal to 1.
        ...
        self.__base_model = base_model_class
        self.__head_model = head_model_class
        self.__num_classes = num_classes
        self._is_graph_network = True

    def call(self, inputs):
        self.built = True
        processed_a = self.__base_model(inputs[0])
        processed_b = self.__base_model(inputs[1])
        return self.__head_model([processed_a, processed_b])
    ...
    def fit_generator(self, x_train, y_train, x_test, y_test, batch_size, *args, **kwargs):
        ...
        return super(SiameseNetwork, self).fit_generator(train_generator,
    ...
    def evaluate_generator(self, x, y, num_positive_pairs, num_negative_pairs, *args, **kwargs):
        ...
        return super(SiameseNetwork, self).evaluate_generator(generator, steps=steps, *args, **kwargs)
    ...
    def __create_pairs(self, x, class_indices, batch_size):
        ...
        * element = x[element_index]
        ...
        """
        positive_pairs, positive_labels = self.__create_positive_pairs(x, class_indices, batch_size / 2)
        negative_pairs, negative_labels = self.__create_negative_pairs(x, class_indices, batch_size / 2)
    ...
    def __create_positive_pairs(self, x, class_indices, num_positive_pairs):
        ...
        * element = x[element_index]
        ...
        for sample in range(num_positive_pairs):
            class_1 = random.randint(0, self.__num_classes - 1)
    ...
    def __create_negative_pairs(self, x, class_indices, num_negative_pairs):
        ...
        * element = x[element_index]
        ...
        for sample in range(num_negative_pairs):
            cls_1, cls_2 = self.__randint_unequal(0, self.__num_classes - 1)
    ...
    def __get_class_indices(self, y):
        ...
        * element = x[element_index]
        ...
        """
        return [np.where(y == i)[0] for i in range(self.__num_classes)]
